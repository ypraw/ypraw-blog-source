...
var createInstantSearchServer = function createInstantSearchServer(algoliasearch) {
  ...
  var findResultsState = function findResultsState(App, props) {
    ...
    (0, _server.renderToString)(_react2.default.createElement(App, props));
    ...
    }, new _algoliasearchHelper.SearchParameters(_extends({ index: indexName }, _reactInstantsearchCore.HIGHLIGHT_TAGS)));
    ...
    var mergedSearchParameters = searchParameters.filter(function (searchParameter) {
      ...
      var sp = searchParameter.getSearchParameters(acc[index] ? acc[index] : sharedSearchParameters, searchParameter.props, searchParameter.searchState);
      acc[index] = sp;
      return acc;
    }, {});
  ...
  var CreateInstantSearchServer = function (_Component) {
    ...
    function CreateInstantSearchServer(props) {
      ...
      if (typeof client.addAlgoliaAgent === 'function') {
        client.addAlgoliaAgent('react-instantsearch ' + _reactInstantsearchCore.version);
      }
...
exports.default = createInstantSearchServer;